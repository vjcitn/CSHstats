...
which is a set of possible outcomes of the random process being
modeled.  For our top-card-drawn example, the sample space 
is the set of suits.  For the fair deck, each point
...
from The Cancer Genome Atlas.  We'll focus on the
