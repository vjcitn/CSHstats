...
appications.  For example, counts of cases of COVID-19 infection
are recorded on a daily basis and presented and interpreted
in various formats.
...
**15:  Show that the proportion of YY1 observations 
...
is defined as $\bar{x} = n^{-1}\sum_i x_i.  The sample variance
...
while for a discrete distribution with probability
mass function $p$ it is
...
**16:  Use code like the above to obtain
...
**17:  How close is the median of the exponential model
