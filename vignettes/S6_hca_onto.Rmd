...
caq_examples = caq_metadata |>
    # sample_ is the upstream harmonized sample identifier used by CuratedAtlasQueryR
    dplyr::select(dataset_id, tissue, cell_type, assay, sample_) |>
    dplyr::distinct() |>
...
assay(sf1[1:4,1:4])
max_cells = 60000
subset_sce = sf1[,1:min(max_cells, ncol(sf1))]
z = DelayedArray::rowSums(assay(subset_sce))
mean(z==0)
todrop = which(z==0)
litsf2 = subset_sce[-todrop,]
assay(litsf2)
