...
caq_examples = caq_metadata |>
    # sample_ is the harmonized sample identifier used by CuratedAtlasQueryR
...
assay(sf1[1:4,1:4])
max_cells = 60000
sampled_sce = sf1[,1:min(max_cells, ncol(sf1))]
z = DelayedArray::rowSums(assay(sampled_sce))
mean(z==0)
todrop = which(z==0)
litsf2 = sampled_sce[-todrop,]
assay(litsf2)
